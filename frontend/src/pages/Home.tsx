...
const Home = () => {
  ...
  const { suggestions, loading: loadingSug } = useAppSelector(
  ...
  const totalPotentialValue = suggestions.reduce(
    ...
    <div className="max-w-7xl mx-auto px-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="mb-10">
        ...
        <p className="text-slate-500 text-lg">
          Visão estratégica e sugestões de produção em tempo real.
        </p>
      </header>
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-2xl font-bold italic">
                AutoFlex Intelligence
              </h2>
              <p className="text-slate-400 text-sm">
                Baseado no estoque atual e composições cadastradas
              </p>
            </div>
          ...
          {loadingSug ? (
            <div className="py-20 text-center text-slate-500">
              Processando algoritmos de produção...
            </div>
          ) : (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="text-3xl font-black text-blue-500">
                        ...
                        <small className="text-sm font-normal opacity-50 ml-1">
                          un
                        </small>
                      </span>
                    </div>
